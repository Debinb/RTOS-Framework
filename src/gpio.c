...
// Enables System Control for the ports (Enables clocking)
...
//Disables the clocking of the ports
...
//Push Pull - Provide current and drain current (drives pins high and low to transmit data)
...
//Open Drain - Drains current (Actively pulls signal low)
...
//Sets the pin to be an input by setting the DIR register as 0
...
//For unlocking ports such as Port F0
...
//Sets the pin to use Auxilary function
...
//Trigger interrupt at both edges
...
//Triggers an interrupt when the pin is high (1)
...
//Triggers an interrupt when the pin is low (0)
...
//Used to set the state of the pin - 0 or 1
...
//Changes the state of the pin (1 becomes 0, 0 becomes 1)
...
//reads the value of ports in bulk
